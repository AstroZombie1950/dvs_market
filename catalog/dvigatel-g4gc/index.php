	...
	<main>
			...
			<div class="product__inner">
				...
				<div class="product-gallery">
					<div class="product-gallery__main">
						<img id="mainImg" src="/img/products/dvigatel-g4gc/1.jpg" alt="двигатель G4GC — Hyundai/Kia" />
					...
					<div class="product-gallery__thumbs">
						<div class="product-gallery__thumb active" onclick="setImg(this, '/img/products/dvigatel-g4gc/1.jpg')">
							<img src="/img/products/dvigatel-g4gc/1.jpg" alt="двигатель G4GC — Hyundai/Kia" />
						</div>
						<div class="product-gallery__thumb" onclick="setImg(this, '/img/products/dvigatel-g4gc/2.jpg')">
							<img src="/img/products/dvigatel-g4gc/2.jpg" alt="двигатель G4GC — Hyundai/Kia" />
						</div>
						<div class="product-gallery__thumb" onclick="setImg(this, '/img/products/dvigatel-g4gc/3.jpg')">
							<img src="/img/products/dvigatel-g4gc/3.jpg" alt="двигатель G4GC — Hyundai/Kia" />
						</div>
						<div class="product-gallery__thumb" onclick="setImg(this, '/img/products/dvigatel-g4gc/4.jpg')">
							<img src="/img/products/dvigatel-g4gc/4.jpg" alt="двигатель G4GC — Hyundai/Kia" />
						</div>
					</div>
					...
					<div class="product-gallery__features">
						...
						<div class="feature-row">
							...
							<span class="feature-row__text">Можем установить Вам двигатель в своём автосервисе</span>
						</div>
						<div class="feature-row">
							<div class="feature-row__icon">
							...
							<span class="feature-row__text">Выдаём ГТД на каждый двигатель</span>
						</div>
					</div>
				</div>
				<!-- правая колонка: инфо -->
				<div class="product-info">
					...
					<div class="product-info__desc">
						...
						— Наша компания реализовала и установила более 500 Новых двигателей<br>
						— Большой опыт. Наша компания на рынке с 2015 г.<br>
		...
		<section class="product-description">
			<div class="product-description__inner">
				...
				<p class="product-description__text">4-х цилиндровый двигатель G4GC объёмом 2.0 л относится к семейству Beta и устанавливается на автомобили Hyundai и Kia. Новый агрегат поставляется с полным комплектом документов и готов к установке.</p>
