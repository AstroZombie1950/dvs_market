...
<head>
	...
	<title>Двигатель G4GC новый — купить в ДВС Маркет</title>
	<meta name="description" content="Купить новый двигатель G4GC в ДВС Маркет. Гарантия 180 дней, документы, подбор по VIN и доставка по России. Уточните наличие и цену." />
	<meta name="keywords" content="двигатель G4GC, мотор G4GC" />
	<meta name="author" content="ДВС Маркет" />
	<meta name="robots" content="index, follow" />
	<link rel="icon" href="/favicon.ico" type="image/x-icon">
	<!-- Open Graph -->
	<meta property="og:title" content="Двигатель G4GC новый — купить в ДВС Маркет" />
	<meta property="og:description" content="Купить новый двигатель G4GC в ДВС Маркет. Гарантия 180 дней, документы, подбор по VIN и доставка по России. Уточните наличие и цену." />
	<meta property="og:type" content="product" />
	<meta property="og:locale" content="ru_RU" />
	<meta property="og:image" content="/img/products/dvigatel-g4gc/1.jpg" />
	<!-- Fonts -->
	...
	<main>
		...
		<section class="product-hero">
			<div class="product-hero__inner">
				<nav class="breadcrumbs product_page_bc" aria-label="Хлебные крошки">
					...
					<span class="breadcrumbs__sep"></span>
					<span class="breadcrumbs__current">Двигатель G4GC</span>
				</nav>
			</div>
		</section>
		<!-- основной блок -->
			...
			<div class="product__inner">
				...
				<div class="product-gallery">
					<div class="product-gallery__main">
						<img id="mainImg" src="/img/products/dvigatel-g4gc/1.jpg" alt="Двигатель G4GC" />
					...
					<div class="product-gallery__thumbs">
						<div class="product-gallery__thumb active" onclick="setImg(this, '/img/products/dvigatel-g4gc/1.jpg')">
							<img src="/img/products/dvigatel-g4gc/1.jpg" alt="Двигатель G4GC" />
						</div>
						<div class="product-gallery__thumb" onclick="setImg(this, '/img/products/dvigatel-g4gc/2.jpg')">
							<img src="/img/products/dvigatel-g4gc/2.jpg" alt="g4gc мотор" />
						</div>
						<div class="product-gallery__thumb" onclick="setImg(this, '/img/products/dvigatel-g4gc/3.jpg')">
							<img src="/img/products/dvigatel-g4gc/3.jpg" alt="киа g4gc" />
						</div>
						<div class="product-gallery__thumb" onclick="setImg(this, '/img/products/dvigatel-g4gc/4.jpg')">
							<img src="/img/products/dvigatel-g4gc/4.jpg" alt="g4gc kia" />
						</div>
					</div>
					<div class="product-gallery__price-block">
						<div class="product-gallery__price">115 000 ₽</div>
				...
				<div class="product-info">
					<h1 class="product-info__title">Двигатель G4GC — Hyundai/Kia</h1>
					<div class="product-info__specs">
						<p class="product-info__spec">Двигатель G4GC</p>
						<p class="product-info__spec">Объём — 2.0</p>
						<p class="product-info__spec">Мощность — 136–143 л.с.</p>
		...
		<section class="product-description">
			<div class="product-description__inner">
				...
				<p class="product-description__text">Двигатель G4GC — бензиновый агрегат объёмом 2.0 л семейства Beta, который устанавливается на ряд моделей Hyundai и Kia и часто выбирается как понятное решение для замены без затяжного ремонта. Перед подбором мы сверяем совместимость по VIN и уточняем комплектацию, чтобы двигатель подошёл по креплениям, навесному оборудованию и датчикам — это помогает избежать лишних расходов и ускоряет установку. Если вам нужен g4gc двигатель без пробега, имеет смысл заранее проверить маркировку, комплектность и наличие документов: так проще подтвердить соответствие и спокойно вводить мотор в эксплуатацию.<br>Мы подскажем, что лучше согласовать до отправки: фото/видео подтверждение, упаковку, условия гарантии и нюансы доставки. Многие клиенты приходят с запросом купить g4gc, когда хотят получить узел в сборе и быстро вернуть автомобиль в работу. Если вы пишете “куплю двигатель g4gc”, мы уточним требования и предложим подходящий вариант под конкретный автомобиль. Также можно подобрать g4gc мотор с документами и гарантией, а стоимость и условия доставки согласуем при оформлении заказа.</p>
				...
				<table class="spec-table" style="margin-bottom:8px;">
					<tbody>
						<tr><td>Киа G4GC / G4GC Kia</td><td>G4GC</td></tr>
						<tr><td>Хендай G4GC / G4GC Hyundai</td><td>G4GC</td></tr>
						<tr><td>Туссан G4GC / G4GC Tucson</td><td>G4GC</td></tr>
						<tr><td>Элантра G4GC / G4GC Elantra</td><td>G4GC</td></tr>
						<tr><td>Соната G4GC / G4GC Sonata</td><td>G4GC</td></tr>
						<tr><td>Спектра G4GC / G4GC Spectra</td><td>G4GC</td></tr>
					</tbody>
				</table>
				...
				<table class="spec-table">
					<tbody>
						...
						<tr><td>Точный объём</td><td>1 975 см³</td></tr>
						<tr><td>Диаметр цилиндра</td><td>82 мм</td></tr>
						<tr><td>Ход поршня</td><td>93.5 мм</td></tr>
						<tr><td>Система питания</td><td>инжектор</td></tr>
						<tr><td>Мощность</td><td>136–143 л.с.</td></tr>
						<tr><td>Крутящий момент</td><td>184–190 Нм</td></tr>
						<tr><td>Степень сжатия</td><td>10.1</td></tr>
						<tr><td>Тип топлива</td><td>АИ-92/АИ-95</td></tr>
						<tr><td>Экологические нормы</td><td>ЕВРО 3/4</td></tr>
					</tbody>
				</table>
			</div>
		</section>
				...
				<div class="faq__list">
					...
					<div class="faq__item reveal reveal--left">
						<button class="faq__question" aria-expanded="false">
							<span>На какие автомобили подходит двигатель G4GC?</span>
							<svg class="faq__icon" viewBox="0 0 24 24"><path d="M19 9l-7 7-7-7"/></svg>
						</button>
						<div class="faq__answer">
							<div class="faq__answer-inner">
								Двигатель G4GC устанавливается на ряд моделей Hyundai и Kia (включая Tucson/Elantra/Sonata/Spectra на отдельных комплектациях). Для точного подбора пришлите VIN — проверим совместимость и нужную комплектацию.
							</div>
						</div>
					</div>
					<div class="faq__item reveal reveal--left">
						<button class="faq__question" aria-expanded="false">
							<span>Какие документы идут вместе с двигателем G4GC?</span>
							<svg class="faq__icon" viewBox="0 0 24 24"><path d="M19 9l-7 7-7-7"/></svg>
						</button>
						<div class="faq__answer">
							<div class="faq__answer-inner">
					...
					<div class="faq__item reveal reveal--left">
						<button class="faq__question" aria-expanded="false">
							<span>Какая гарантия на новый двигатель G4GC и как проходит доставка?</span>
							<svg class="faq__icon" viewBox="0 0 24 24"><path d="M19 9l-7 7-7-7"/></svg>
						</button>
						<div class="faq__answer">
							<div class="faq__answer-inner">
