...
<head>
	...
	<title>Двигатель G4FC новый — купить в ДВС Маркет</title>
	<meta name="description" content="Купить новый двигатель G4FC в ДВС Маркет. Гарантия 180 дней, документы, подбор по VIN и доставка по России. Уточните наличие и цену." />
	<meta name="keywords" content="двигатель G4FC, мотор G4FC, купить G4FC, двигатель Hyundai G4FC, двигатель Kia G4FC, новый двигатель G4FC" />
	<meta name="author" content="ДВС Маркет" />
	<meta name="robots" content="index, follow" />
	<link rel="icon" href="/favicon.ico" type="image/x-icon">
	<!-- Open Graph -->
	<meta property="og:title" content="Двигатель G4FC новый — ДВС Маркет" />
	<meta property="og:description" content="Купить новый двигатель G4FC в ДВС Маркет. Гарантия 180 дней, документы, подбор по VIN и доставка по России." />
	<meta property="og:type" content="product" />
	<meta property="og:locale" content="ru_RU" />
	<meta property="og:image" content="/img/products/dvigatel-g4fc/1.jpg" />
	<!-- Fonts -->
	...
	<main>
		...
		<section class="product-hero">
			<div class="product-hero__inner">
				<nav class="breadcrumbs product_page_bc" aria-label="Хлебные крошки">
					...
					<span class="breadcrumbs__sep"></span>
					<span class="breadcrumbs__current">Двигатель G4FC</span>
				</nav>
			</div>
		</section>
		<!-- основной блок -->
			...
			<div class="product__inner">
				...
				<div class="product-gallery">
					<div class="product-gallery__main">
						<img id="mainImg" src="/img/products/dvigatel-g4fc/1.jpg" alt="Двигатель G4FC" />
					...
					<div class="product-gallery__thumbs">
						<div class="product-gallery__thumb active" onclick="setImg(this, '/img/products/dvigatel-g4fc/1.jpg')">
							<img src="/img/products/dvigatel-g4fc/1.jpg" alt="Двигатель G4FC" />
						</div>
						<div class="product-gallery__thumb" onclick="setImg(this, '/img/products/dvigatel-g4fc/2.jpg')">
							<img src="/img/products/dvigatel-g4fc/2.jpg" alt="g4fc мотор" />
						</div>
						<div class="product-gallery__thumb" onclick="setImg(this, '/img/products/dvigatel-g4fc/3.jpg')">
							<img src="/img/products/dvigatel-g4fc/3.jpg" alt="киа g4fc" />
						</div>
						<div class="product-gallery__thumb" onclick="setImg(this, '/img/products/dvigatel-g4fc/4.jpg')">
							<img src="/img/products/dvigatel-g4fc/4.jpg" alt="g4fc kia" />
						</div>
					</div>
					<div class="product-gallery__price-block">
						<div class="product-gallery__price">84 000 ₽</div>
				...
				<div class="product-info">
					<h1 class="product-info__title">Двигатель G4FC — Hyundai/Kia</h1>
					<div class="product-info__specs">
						<p class="product-info__spec">Двигатель G4FC</p>
						<p class="product-info__spec">Объём — 1.6</p>
						<p class="product-info__spec">Мощность — 122–126 л.с.</p>
		...
		<section class="product-description">
			<div class="product-description__inner">
				...
				<p class="product-description__text">Двигатель G4FC — популярный бензиновый агрегат объёмом 1.6 л, который часто выбирают как готовое решение для замены, когда важны предсказуемая установка и стабильная работа. Перед подбором мы сверяем совместимость по VIN и уточняем комплектацию, чтобы исключить ошибки по креплениям, навесному оборудованию и датчикам. Если вам нужен g4fc двигатель без пробега, имеет смысл заранее проверить маркировку, комплектность и наличие документов — это ускоряет установку и снижает риски при дальнейшем обслуживании.<br>Мы подскажем, на что обратить внимание до отправки: состояние узлов, упаковку, возможность фото/видео подтверждения, а также условия гарантии и логистики. Многие клиенты приходят с запросом купить g4fc, потому что хотят получить узел в сборе и быстро вернуть автомобиль в работу без затяжного ремонта. Если вы пишете “куплю двигатель g4fc”, мы уточним требования и предложим подходящий вариант под ваш запрос. Также можно подобрать g4fc мотор с документами и гарантией, а детали по доставке согласуем заранее.</p>
				...
				<table class="spec-table" style="margin-bottom:8px;">
					<tbody>
						<tr><td>Kia / Киа</td><td>G4FC</td></tr>
						<tr><td>Hyundai / Хендай</td><td>G4FC</td></tr>
						<tr><td>Solaris / Солярис</td><td>G4FC</td></tr>
						<tr><td>Rio / Рио</td><td>G4FC</td></tr>
						<tr><td>Ceed / Сид</td><td>G4FC</td></tr>
					</tbody>
				</table>
				...
				<table class="spec-table">
					<tbody>
						...
						<tr><td>Мощность</td><td>122–126 л.с.</td></tr>
						<tr><td>Крутящий момент</td><td>154–157 Нм</td></tr>
				...
				<div class="faq__list">
					...
					<div class="faq__item reveal reveal--left">
						<button class="faq__question" aria-expanded="false">
							<span>На какие автомобили подходит двигатель G4FC?</span>
							<svg class="faq__icon" viewBox="0 0 24 24"><path d="M19 9l-7 7-7-7"/></svg>
						</button>
						<div class="faq__answer">
							<div class="faq__answer-inner">
								Двигатель G4FC встречается на ряде моделей Hyundai и Kia (включая Solaris/Rio/Ceed на отдельных комплектациях). Для точного подбора пришлите VIN — проверим совместимость и нужную комплектацию.
							</div>
						</div>
					</div>
					<div class="faq__item reveal reveal--left">
						<button class="faq__question" aria-expanded="false">
							<span>Какие документы идут вместе с двигателем G4FC?</span>
							<svg class="faq__icon" viewBox="0 0 24 24"><path d="M19 9l-7 7-7-7"/></svg>
						</button>
						<div class="faq__answer">
							<div class="faq__answer-inner">
					...
					<div class="faq__item reveal reveal--left">
						<button class="faq__question" aria-expanded="false">
							<span>Какая гарантия на новый двигатель G4FC и как проходит доставка?</span>
							<svg class="faq__icon" viewBox="0 0 24 24"><path d="M19 9l-7 7-7-7"/></svg>
						</button>
						<div class="faq__answer">
							<div class="faq__answer-inner">
