...
<head>
	...
	<title>Двигатель G4FG новый — купить в ДВС Маркет</title>
	<meta name="description" content="Купить новый двигатель G4FG в ДВС Маркет. Гарантия 180 дней, документы, подбор по VIN и доставка по России. Уточните наличие и цену." />
	<meta name="keywords" content="двигатель G4FG, мотор G4FG, купить G4FG, двигатель Hyundai G4FG, двигатель Kia G4FG, новый двигатель G4FG" />
	<meta name="author" content="ДВС Маркет" />
	<meta name="robots" content="index, follow" />
	<link rel="icon" href="/favicon.ico" type="image/x-icon">
	<!-- Open Graph -->
	<meta property="og:title" content="Двигатель G4FG новый — ДВС Маркет" />
	<meta property="og:description" content="Купить новый двигатель G4FG в ДВС Маркет. Гарантия 180 дней, документы, подбор по VIN и доставка по России." />
	<meta property="og:type" content="product" />
	<meta property="og:locale" content="ru_RU" />
	<meta property="og:image" content="/img/products/dvigatel-g4fg/1.jpg" />
	<!-- Fonts -->
	...
	<main>
		...
		<section class="product-hero">
			<div class="product-hero__inner">
				<nav class="breadcrumbs product_page_bc" aria-label="Хлебные крошки">
					...
					<span class="breadcrumbs__sep"></span>
					<span class="breadcrumbs__current">Двигатель G4FG</span>
				</nav>
			</div>
		</section>
		<!-- основной блок -->
			...
			<div class="product__inner">
				...
				<div class="product-gallery">
					<div class="product-gallery__main">
						<img id="mainImg" src="/img/products/dvigatel-g4fg/1.jpg" alt="Двигатель G4FG" />
					...
					<div class="product-gallery__thumbs">
						<div class="product-gallery__thumb active" onclick="setImg(this, '/img/products/dvigatel-g4fg/1.jpg')">
							<img src="/img/products/dvigatel-g4fg/1.jpg" alt="Двигатель G4FG" />
						</div>
						<div class="product-gallery__thumb" onclick="setImg(this, '/img/products/dvigatel-g4fg/2.jpg')">
							<img src="/img/products/dvigatel-g4fg/2.jpg" alt="g4fg мотор" />
						</div>
						<div class="product-gallery__thumb" onclick="setImg(this, '/img/products/dvigatel-g4fg/3.jpg')">
							<img src="/img/products/dvigatel-g4fg/3.jpg" alt="киа g4fg" />
						</div>
						<div class="product-gallery__thumb" onclick="setImg(this, '/img/products/dvigatel-g4fg/4.jpg')">
							<img src="/img/products/dvigatel-g4fg/4.jpg" alt="g4fg kia" />
						</div>
					</div>
					<div class="product-gallery__price-block">
						<div class="product-gallery__price">88 000 ₽</div>
				...
				<div class="product-info">
					<h1 class="product-info__title">Двигатель G4FG — Hyundai/Kia</h1>
					<div class="product-info__specs">
						<p class="product-info__spec">Двигатель G4FG</p>
						<p class="product-info__spec">Объём — 1.6</p>
						<p class="product-info__spec">Мощность — 121–123 л.с.</p>
		...
		<section class="product-description">
			<div class="product-description__inner">
				...
				<p class="product-description__text">Двигатель G4FG — бензиновый агрегат объёмом 1.6 л из семейства Gamma, который ставится на ряд моделей Hyundai и Kia и часто выбирается как понятное решение для замены. Перед подбором мы сверяем совместимость по VIN и уточняем комплектацию, чтобы двигатель подошёл по креплениям, навесному и датчикам, без лишних доработок на установке. Если вам нужен g4fg двигатель без пробега, важно заранее проверить маркировку и комплектность, а также убедиться, что есть документы — это упрощает оформление и дальнейшую эксплуатацию.<br>Мы подскажем, на что обратить внимание до отправки: состояние узлов, упаковку, возможность фото/видео подтверждения и нюансы по гарантийному сопровождению. Многие клиенты приходят с запросом купить g4fg, когда хотят получить узел в сборе и быстро вернуть автомобиль в работу без затяжного ремонта. Если вы пишете “куплю двигатель g4fg”, мы уточним ваши требования и предложим подходящий вариант под конкретный автомобиль. Также можно подобрать g4fg мотор с документами и гарантией, а условия доставки и стоимость согласуем заранее.</p>
				...
				<table class="spec-table" style="margin-bottom:8px;">
					<tbody>
						<tr><td>Kia / Киа</td><td>G4FG</td></tr>
						<tr><td>Hyundai / Хендай</td><td>G4FG</td></tr>
						<tr><td>Creta / Крета</td><td>G4FG</td></tr>
						<tr><td>Rio / Рио</td><td>G4FG</td></tr>
						<tr><td>Ceed / Сид</td><td>G4FG</td></tr>
					</tbody>
				</table>
				...
				<table class="spec-table">
					<tbody>
						...
						<tr><td>Точный объём</td><td>1 591 см³</td></tr>
						<tr><td>Диаметр цилиндра</td><td>77 мм</td></tr>
						<tr><td>Ход поршня</td><td>85.4 мм</td></tr>
						<tr><td>Система питания</td><td>инжектор (MPI)</td></tr>
						<tr><td>Мощность</td><td>121–123 л.с.</td></tr>
				...
				<div class="faq__list">
					...
					<div class="faq__item reveal reveal--left">
						<button class="faq__question" aria-expanded="false">
							<span>На какие автомобили подходит двигатель G4FG?</span>
							<svg class="faq__icon" viewBox="0 0 24 24"><path d="M19 9l-7 7-7-7"/></svg>
						</button>
						<div class="faq__answer">
							<div class="faq__answer-inner">
								Двигатель G4FG встречается на ряде моделей Hyundai и Kia (включая Creta/Rio/Ceed на отдельных комплектациях). Для точного подбора пришлите VIN — проверим совместимость и нужную комплектацию.
							</div>
						</div>
					</div>
					<div class="faq__item reveal reveal--left">
						<button class="faq__question" aria-expanded="false">
							<span>Какие документы идут вместе с двигателем G4FG?</span>
							<svg class="faq__icon" viewBox="0 0 24 24"><path d="M19 9l-7 7-7-7"/></svg>
						</button>
						<div class="faq__answer">
							<div class="faq__answer-inner">
					...
					<div class="faq__item reveal reveal--left">
						<button class="faq__question" aria-expanded="false">
							<span>Какая гарантия на новый двигатель G4FG и как проходит доставка?</span>
							<svg class="faq__icon" viewBox="0 0 24 24"><path d="M19 9l-7 7-7-7"/></svg>
						</button>
						<div class="faq__answer">
							<div class="faq__answer-inner">
