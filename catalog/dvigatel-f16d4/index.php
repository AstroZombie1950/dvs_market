...
<head>
	...
	<title>Двигатель F16D4 новый — купить в ДВС Маркет</title>
	<meta name="description" content="Купить новый двигатель F16D4 в ДВС Маркет. Гарантия 180 дней, документы, подбор по VIN и доставка по России. Уточните наличие и цену." />
	<meta name="keywords" content="двигатель F16D4, мотор F16D4, купить F16D4, двигатель Chevrolet F16D4, новый двигатель F16D4" />
	<meta name="author" content="ДВС Маркет" />
	<meta name="robots" content="index, follow" />
	<link rel="icon" href="/favicon.ico" type="image/x-icon">
	<!-- Open Graph -->
	<meta property="og:title" content="Двигатель F16D4 новый — ДВС Маркет" />
	<meta property="og:description" content="Купить новый двигатель F16D4 в ДВС Маркет. Гарантия 180 дней, документы, подбор по VIN и доставка по России." />
	<meta property="og:type" content="product" />
	<meta property="og:locale" content="ru_RU" />
	<meta property="og:image" content="/img/products/dvigatel-f16d4/1.jpg" />
	<!-- Fonts -->
	...
	<main>
		...
		<section class="product-hero">
			<div class="product-hero__inner">
				<nav class="breadcrumbs product_page_bc" aria-label="Хлебные крошки">
					<a href="/">Главная</a>
					<span class="breadcrumbs__sep"></span>
					<a href="/catalog">Каталог</a>
					<span class="breadcrumbs__sep"></span>
					<span class="breadcrumbs__current">Двигатель F16D4</span>
				</nav>
			</div>
		</section>
		<!-- основной блок -->
			...
			<div class="product__inner">
				...
				<div class="product-gallery">
					<div class="product-gallery__main">
						<img id="mainImg" src="/img/products/dvigatel-f16d4/1.jpg" alt="Двигатель F16D4" />
					...
					<div class="product-gallery__thumbs">
						<div class="product-gallery__thumb active" onclick="setImg(this, '/img/products/dvigatel-f16d4/1.jpg')">
							<img src="/img/products/dvigatel-f16d4/1.jpg" alt="Двигатель F16D4" />
						</div>
						<div class="product-gallery__thumb" onclick="setImg(this, '/img/products/dvigatel-f16d4/2.jpg')">
							<img src="/img/products/dvigatel-f16d4/2.jpg" alt="f16d4 мотор" />
						</div>
						<div class="product-gallery__thumb" onclick="setImg(this, '/img/products/dvigatel-f16d4/3.jpg')">
							<img src="/img/products/dvigatel-f16d4/3.jpg" alt="шевроле f16d4" />
						</div>
						<div class="product-gallery__thumb" onclick="setImg(this, '/img/products/dvigatel-f16d4/4.jpg')">
							<img src="/img/products/dvigatel-f16d4/4.jpg" alt="f16d4 chevrolet" />
						</div>
					</div>
					<div class="product-gallery__price-block">
						<div class="product-gallery__price">106 000 ₽</div>
					...
					<!-- преимущества — типовые, без изменений -->
				...
				<div class="product-info">
					<h1 class="product-info__title">Двигатель F16D4 — Chevrolet</h1>
					<div class="product-info__specs">
						<p class="product-info__spec">Двигатель F16D4</p>
						<p class="product-info__spec">Объём — 1.6</p>
						<p class="product-info__spec">Мощность — 109–124 л.с.</p>
						<p class="product-info__spec">Тип двигателя — рядный 4-х цилиндровый</p>
					...
					<div class="product-info__desc">
						<p><em>БЕСПЛАТНО проконсультируем вас или вашего мастера, как правильно произвести установку и первый запуск нового двигателя!</em></p>
						<p><em>У НАС САМЫЕ ВЫГОДНЫЕ ЦЕНЫ!!</em><br>Мы работаем напрямую с заводом.<br><em>Нашли цену дешевле, позвоните нам и мы согласуем цену ниже.</em></p>
						<p>Большой выбор в наличии на складе.</p>
						<p>Для АВТОСЕРВИСОВ особые условия, мы открыты к постоянному взаимовыгодному сотрудничеству.</p>
						...
						<p><em><strong>Оставьте заявку</strong> или <strong>позвоните!</strong> Мы будем рады вам помочь!</em></p>
					</div>
		...
		<section class="product-description">
			<div class="product-description__inner">
				...
				<p class="product-description__text">Двигатель F16D4 — бензиновый агрегат объёмом 1.6 л, который применяется на автомобилях Chevrolet и подходит, когда нужна замена без затяжного ремонта и экспериментов с совместимостью. Самая частая ошибка при заказе — ориентироваться только на название: у одного и того же мотора могут отличаться комплектации по навесному, разъёмам и датчикам. Поэтому перед оформлением мы сверяем данные по VIN и уточняем, что именно нужно под вашу машину, чтобы установка прошла без лишних переделок и дополнительных трат.<br>Если вы ищете f16d4 двигатель без пробега, в первую очередь важно проверить маркировку и комплектность: так проще подтвердить соответствие и спокойно планировать установку. Перед отправкой можно согласовать фото и видео, чтобы вы заранее увидели маркировку и общее состояние узла, а также упаковку — это снижает риск вопросов при приёмке. В переписке часто встречаются формулировки “куплю двигатель f16d4” или “купить f16d4” — в таких случаях мы сначала уточняем VIN, затем подтверждаем нужную модификацию и согласуем детали по отгрузке.<br>F16D4 мотор обычно берут, когда важно быстро вернуть автомобиль в рабочее состояние и получить прогнозируемый результат после установки. Условия гарантии и доставки по России уточняются при оформлении заказа — подскажем оптимальный вариант под ваш регион и формат получения.</p>
				...
				<table class="spec-table" style="margin-bottom:8px;">
					<tbody>
						<tr><td>Chevrolet / Шевроле</td><td>F16D4</td></tr>
						<tr><td>Cruze / Круз</td><td>F16D4</td></tr>
						<tr><td>Aveo / Авео</td><td>F16D4</td></tr>
					</tbody>
				</table>
				...
				<table class="spec-table">
					<tbody>
						<tr><td>Тип</td><td>рядный</td></tr>
						<tr><td>Кол-во цилиндров</td><td>4</td></tr>
						<tr><td>Кол-во клапанов</td><td>16</td></tr>
						<tr><td>Точный объём</td><td>1 598 см³</td></tr>
						<tr><td>Диаметр цилиндра</td><td>79 мм</td></tr>
						<tr><td>Ход поршня</td><td>81.5 мм</td></tr>
						<tr><td>Система питания</td><td>инжектор</td></tr>
						<tr><td>Мощность</td><td>109–124 л.с.</td></tr>
						<tr><td>Крутящий момент</td><td>150–155 Нм</td></tr>
						<tr><td>Степень сжатия</td><td>10.5</td></tr>
						<tr><td>Тип топлива</td><td>АИ-92/АИ-95</td></tr>
						<tr><td>Экологические нормы</td><td>ЕВРО 4/5</td></tr>
					</tbody>
				</table>
			</div>
		</section>
		...
		<section class="faq">
			<div class="faq__inner">
				...
				<div class="faq__list">
					<!-- 3 вопроса из документа -->
					<div class="faq__item reveal reveal--left">
						<button class="faq__question" aria-expanded="false">
							<span>На какие автомобили подходит двигатель F16D4?</span>
							<svg class="faq__icon" viewBox="0 0 24 24"><path d="M19 9l-7 7-7-7"/></svg>
						</button>
						<div class="faq__answer">
							<div class="faq__answer-inner">
								Двигатель F16D4 устанавливается на ряд моделей Chevrolet (включая Cruze и Aveo на отдельных комплектациях). Для точного подбора пришлите VIN — проверим совместимость и нужную комплектацию.
							</div>
						</div>
					</div>
					<div class="faq__item reveal reveal--left">
						<button class="faq__question" aria-expanded="false">
							<span>Какие документы идут вместе с двигателем F16D4?</span>
							<svg class="faq__icon" viewBox="0 0 24 24"><path d="M19 9l-7 7-7-7"/></svg>
						</button>
						<div class="faq__answer">
							<div class="faq__answer-inner">
								Двигатель поставляется с комплектом документов. Перед отправкой подтвердим маркировку и при необходимости сделаем фото/видео.
							</div>
						</div>
					</div>
					<div class="faq__item reveal reveal--left">
						<button class="faq__question" aria-expanded="false">
							<span>Какая гарантия на новый двигатель F16D4 и как проходит доставка?</span>
							<svg class="faq__icon" viewBox="0 0 24 24"><path d="M19 9l-7 7-7-7"/></svg>
						</button>
						<div class="faq__answer">
							<div class="faq__answer-inner">
								Гарантия на двигатель — 180 дней. Доставляем по России, условия и стоимость доставки уточняются при оформлении заказа.
							</div>
						</div>
					</div>
					<!-- 4 типовых вопроса -->
