...
<head>
	...
	<title>Двигатель F16D3 новый — купить в ДВС Маркет</title>
	<meta name="description" content="Купить новый двигатель F16D3 в ДВС Маркет. Гарантия 180 дней, документы, подбор по VIN и доставка по России. Уточните наличие и цену." />
	<meta name="keywords" content="двигатель F16D3, мотор F16D3, купить F16D3, двигатель Chevrolet F16D3, двигатель Daewoo F16D3, новый двигатель F16D3" />
	<meta name="author" content="ДВС Маркет" />
	<meta name="robots" content="index, follow" />
	<link rel="icon" href="/favicon.ico" type="image/x-icon">
	<!-- Open Graph -->
	<meta property="og:title" content="Двигатель F16D3 новый — ДВС Маркет" />
	<meta property="og:description" content="Купить новый двигатель F16D3 в ДВС Маркет. Гарантия 180 дней, документы, подбор по VIN и доставка по России." />
	<meta property="og:type" content="product" />
	<meta property="og:locale" content="ru_RU" />
	<meta property="og:image" content="/img/products/dvigatel-f16d3/1.jpg" />
	<!-- Fonts -->
		...
		<section class="product-hero">
			<div class="product-hero__inner">
				<nav class="breadcrumbs product_page_bc" aria-label="Хлебные крошки">
					...
					<span class="breadcrumbs__sep"></span>
					<span class="breadcrumbs__current">Двигатель F16D3</span>
				</nav>
			</div>
		</section>
		<!-- основной блок -->
			...
			<div class="product__inner">
				...
				<div class="product-gallery">
					...
					<div class="product-gallery__price-block">
						<div class="product-gallery__price">101 000 ₽</div>
				...
				<div class="product-info">
					<h1 class="product-info__title">Двигатель F16D3 — Chevrolet/Daewoo</h1>
					<div class="product-info__specs">
						<p class="product-info__spec">Двигатель F16D3</p>
						<p class="product-info__spec">Объём — 1.6</p>
						<p class="product-info__spec">Мощность — 106–109 л.с.</p>
		...
		<section class="product-description">
			<div class="product-description__inner">
				...
				<table class="spec-table" style="margin-bottom:8px;">
					<tbody>
						<tr><td>Chevrolet / Шевроле</td><td>F16D3</td></tr>
						<tr><td>Daewoo / Дэу</td><td>F16D3</td></tr>
						<tr><td>Lacetti / Лачетти</td><td>F16D3</td></tr>
						<tr><td>Cruze / Круз</td><td>F16D3</td></tr>
					</tbody>
				</table>
				...
				<table class="spec-table">
					<tbody>
						...
						<tr><td>Мощность</td><td>106–109 л.с.</td></tr>
						<tr><td>Крутящий момент</td><td>150 Нм</td></tr>
						<tr><td>Степень сжатия</td><td>9.5</td></tr>
				...
				<div class="faq__list">
					...
					<div class="faq__item reveal reveal--left">
						<button class="faq__question" aria-expanded="false">
							<span>На какие автомобили подходит двигатель F16D3?</span>
							<svg class="faq__icon" viewBox="0 0 24 24"><path d="M19 9l-7 7-7-7"/></svg>
						</button>
						<div class="faq__answer">
							<div class="faq__answer-inner">
								Двигатель F16D3 устанавливается на ряд моделей Chevrolet и Daewoo (включая Lacetti и некоторые версии Cruze). Для точного подбора пришлите VIN — проверим совместимость и нужную комплектацию.
							</div>
						</div>
					</div>
					<div class="faq__item reveal reveal--left">
						<button class="faq__question" aria-expanded="false">
							<span>Какие документы идут вместе с двигателем F16D3?</span>
							<svg class="faq__icon" viewBox="0 0 24 24"><path d="M19 9l-7 7-7-7"/></svg>
						</button>
						<div class="faq__answer">
							<div class="faq__answer-inner">
					...
					<div class="faq__item reveal reveal--left">
						<button class="faq__question" aria-expanded="false">
							<span>Какая гарантия на новый двигатель F16D3 и как проходит доставка?</span>
							<svg class="faq__icon" viewBox="0 0 24 24"><path d="M19 9l-7 7-7-7"/></svg>
						</button>
						<div class="faq__answer">
							<div class="faq__answer-inner">
