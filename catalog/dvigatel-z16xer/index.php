...
<head>
	...
	<title>Двигатель Z16XER новый — купить в ДВС Маркет</title>
	<meta name="description" content="Купить новый двигатель Z16XER в ДВС Маркет. Гарантия 180 дней, документы, подбор по VIN и доставка по России. Уточните наличие и цену." />
	<meta name="keywords" content="двигатель Z16XER, мотор Z16XER" />
	<meta name="author" content="ДВС Маркет" />
	<meta name="robots" content="index, follow" />
	<link rel="icon" href="/favicon.ico" type="image/x-icon">
	<!-- Open Graph -->
	<meta property="og:title" content="Двигатель Z16XER новый — купить в ДВС Маркет" />
	<meta property="og:description" content="Купить новый двигатель Z16XER в ДВС Маркет. Гарантия 180 дней, документы, подбор по VIN и доставка по России." />
	<meta property="og:type" content="product" />
	<meta property="og:locale" content="ru_RU" />
	<meta property="og:image" content="/img/products/dvigatel-z16xer/1.jpg" />
	<!-- Fonts -->
    ...
    <main>
        ...
        <section class="product-hero">
            <div class="product-hero__inner">
                <nav class="breadcrumbs product_page_bc">
                    ...
                    <span class="breadcrumbs__sep"></span>
                    <span class="breadcrumbs__current">Двигатель Z16XER</span>
                </nav>
            </div>
        </section>
		<!-- основной блок -->
            ...
            <div class="product__inner">
                <div class="product-gallery">
                    <div class="product-gallery__main">
                        <img id="mainImg" src="/img/products/dvigatel-z16xer/1.jpg" alt="Двигатель Z16XER" />
                    ...
                    <div class="product-gallery__thumbs">
                        <div class="product-gallery__thumb active" onclick="setImg(this, '/img/products/dvigatel-z16xer/1.jpg')">
                            <img src="/img/products/dvigatel-z16xer/1.jpg" alt="Двигатель Z16XER" />
                        </div>
                        <div class="product-gallery__thumb" onclick="setImg(this, '/img/products/dvigatel-z16xer/2.jpg')">
                            <img src="/img/products/dvigatel-z16xer/2.jpg" alt="z16xer мотор" />
                        </div>
                        <div class="product-gallery__thumb" onclick="setImg(this, '/img/products/dvigatel-z16xer/3.jpg')">
                            <img src="/img/products/dvigatel-z16xer/3.jpg" alt="опель z16xer" />
                        </div>
                        <div class="product-gallery__thumb" onclick="setImg(this, '/img/products/dvigatel-z16xer/4.jpg')">
                            <img src="/img/products/dvigatel-z16xer/4.jpg" alt="z16xer opel" />
                        </div>
                    </div>
                    <div class="product-gallery__price-block">
                        <div class="product-gallery__price">112 000 ₽</div>
                ...
                <div class="product-info">
                    <h1 class="product-info__title">Двигатель Z16XER — Opel</h1>
                    <div class="product-info__specs">
                        <p class="product-info__spec">Двигатель Z16XER</p>
                        <p class="product-info__spec">Объём — 1.6</p>
                        <p class="product-info__spec">Мощность — 115–116 л.с.</p>
        ...
        <section class="product-description">
            <div class="product-description__inner">
                ...
                <p class="product-description__text">Двигатель Z16XER — бензиновый 4-х цилиндровый агрегат объёмом 1.6 л, который устанавливается на автомобили Opel и часто выбирается как понятное решение для замены, когда важны предсказуемая установка и стабильная работа после ремонта. При заказе важно учитывать не только индекс, но и комплектацию: у разных годов выпуска могут отличаться навесное оборудование, разъёмы, датчики и мелкие посадочные элементы. Поэтому перед оформлением мы сверяем данные по VIN и уточняем, что именно нужно под ваш автомобиль, чтобы установка прошла без переделок и лишних расходов.<br>Если вам нужен z16xer двигатель без пробега, имеет смысл заранее проверить маркировку и комплектность — так проще подтвердить соответствие и спокойно планировать установку. Перед отправкой можно согласовать фото и видео, чтобы заранее увидеть маркировку и состояние узла, а также как упакован двигатель для перевозки. В переписке часто встречаются запросы “куплю двигатель z16xer” или “купить z16xer” — в таких случаях мы сначала уточняем VIN, затем подтверждаем нужную модификацию и согласуем детали отгрузки.<br>Z16XER мотор обычно берут, когда нужно быстро вернуть автомобиль в рабочее состояние и получить прогнозируемый результат после установки. Условия гарантии и доставка по России уточняются при оформлении заказа — подскажем оптимальный вариант под ваш регион и удобный способ получения.</p>
                ...
                <table class="spec-table" style="margin-bottom:8px;">
                    <tr><td>Опель Z16XER / Z16XER Opel</td><td>Z16XER</td></tr>
                    <tr><td>Астра Z16XER / Z16XER Astra</td><td>Z16XER</td></tr>
                    <tr><td>Зафира Z16XER / Z16XER Zafira</td><td>Z16XER</td></tr>
                    <tr><td>Мерива Z16XER / Z16XER Meriva</td><td>Z16XER</td></tr>
                </table>
                ...
                <table class="spec-table">
                    ...
                    <tr><td>Мощность</td><td>115–116 л.с.</td></tr>
                    <tr><td>Крутящий момент</td><td>155 Нм</td></tr>
                    <tr><td>Степень сжатия</td><td>10.8</td></tr>
                    <tr><td>Тип топлива</td><td>АИ-95</td></tr>
				...
				<div class="faq__list">
					...
					<div class="faq__item reveal reveal--left">
						<button class="faq__question" aria-expanded="false">
							<span>На какие автомобили подходит двигатель Z16XER?</span>
							<svg class="faq__icon" viewBox="0 0 24 24"><path d="M19 9l-7 7-7-7"/></svg>
						</button>
						<div class="faq__answer">
							<div class="faq__answer-inner">Двигатель Z16XER устанавливается на ряд моделей Opel (Astra, Zafira, Meriva на отдельных комплектациях). Для точного подбора пришлите VIN — проверим совместимость и нужную комплектацию.</div>
						</div>
					</div>
					<div class="faq__item reveal reveal--left">
						<button class="faq__question" aria-expanded="false">
							<span>Какие документы идут вместе с двигателем Z16XER?</span>
							<svg class="faq__icon" viewBox="0 0 24 24"><path d="M19 9l-7 7-7-7"/></svg>
						</button>
						<div class="faq__answer">
					...
					<div class="faq__item reveal reveal--left">
						<button class="faq__question" aria-expanded="false">
							<span>Какая гарантия на новый двигатель Z16XER и как проходит доставка?</span>
							<svg class="faq__icon" viewBox="0 0 24 24"><path d="M19 9l-7 7-7-7"/></svg>
						</button>
						<div class="faq__answer">
