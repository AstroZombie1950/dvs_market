                ...
                <div class="product-gallery">
                    ...
                    <div class="product-gallery__thumbs">
                        ...
                        <div class="product-gallery__thumb" onclick="setImg(this, '/img/products/dvigatel-z16xer/2.jpg')">
                            <img src="/img/products/dvigatel-z16xer/2.jpg" alt="двигатель Z16XER" />
                        </div>
                        <div class="product-gallery__thumb" onclick="setImg(this, '/img/products/dvigatel-z16xer/3.jpg')">
                            <img src="/img/products/dvigatel-z16xer/3.jpg" alt="двигатель Z16XER" />
                        </div>
                        <div class="product-gallery__thumb" onclick="setImg(this, '/img/products/dvigatel-z16xer/4.jpg')">
                            <img src="/img/products/dvigatel-z16xer/4.jpg" alt="двигатель Z16XER" />
                        </div>
                    </div>
        ...
        <section class="product-description">
            <div class="product-description__inner">
                ...
                <p class="product-description__text">
                    4-х цилиндровый двигатель Z16XER объёмом 1.6 л устанавливается на автомобили Opel. Новый агрегат поставляется с полным комплектом документов и готов к установке.
                </p>
