...
<head>
	...
	<title>Двигатель G4KD новый — купить в ДВС Маркет</title>
	<meta name="description" content="Купить новый двигатель G4KD в ДВС Маркет. Гарантия 180 дней, документы, подбор по VIN и доставка по России. Уточните наличие и цену." />
	<meta name="keywords" content="двигатель G4KD, мотор G4KD" />
	<meta name="author" content="ДВС Маркет" />
	<meta name="robots" content="index, follow" />
	<link rel="icon" href="/favicon.ico" type="image/x-icon">
	<!-- Open Graph -->
	<meta property="og:title" content="Двигатель G4KD новый — купить в ДВС Маркет" />
	<meta property="og:description" content="Купить новый двигатель G4KD в ДВС Маркет. Гарантия 180 дней, документы, подбор по VIN и доставка по России." />
	<meta property="og:type" content="product" />
	<meta property="og:locale" content="ru_RU" />
	<meta property="og:image" content="/img/products/dvigatel-g4kd/1.jpg" />
	<!-- Fonts -->
    ...
    <main>
        ...
        <section class="product-hero">
            <div class="product-hero__inner">
                <nav class="breadcrumbs product_page_bc" aria-label="Хлебные крошки">
                    ...
                    <span class="breadcrumbs__sep"></span>
                    <span class="breadcrumbs__current">Двигатель G4KD</span>
                </nav>
            </div>
        </section>
		<!-- основной блок -->
            ...
            <div class="product__inner">
                <div class="product-gallery">
                    <div class="product-gallery__main">
                        <img id="mainImg" src="/img/products/dvigatel-g4kd/1.jpg" alt="Двигатель G4KD" />
                    ...
                    <div class="product-gallery__thumbs">
                        <div class="product-gallery__thumb active" onclick="setImg(this, '/img/products/dvigatel-g4kd/1.jpg')">
                            <img src="/img/products/dvigatel-g4kd/1.jpg" alt="Двигатель G4KD" />
                        </div>
                        <div class="product-gallery__thumb" onclick="setImg(this, '/img/products/dvigatel-g4kd/2.jpg')">
                            <img src="/img/products/dvigatel-g4kd/2.jpg" alt="g4kd мотор" />
                        </div>
                        <div class="product-gallery__thumb" onclick="setImg(this, '/img/products/dvigatel-g4kd/3.jpg')">
                            <img src="/img/products/dvigatel-g4kd/3.jpg" alt="киа g4kd" />
                        </div>
                        <div class="product-gallery__thumb" onclick="setImg(this, '/img/products/dvigatel-g4kd/4.jpg')">
                            <img src="/img/products/dvigatel-g4kd/4.jpg" alt="g4kd kia" />
                        </div>
                    </div>
                    <div class="product-gallery__price-block">
                        <div class="product-gallery__price">130 000 ₽</div>
                ...
                <div class="product-info">
                    <h1 class="product-info__title">Двигатель G4KD — Hyundai/Kia</h1>
                    <div class="product-info__specs">
                        <p class="product-info__spec">Двигатель G4KD</p>
                        <p class="product-info__spec">Объём — 2.0</p>
                        <p class="product-info__spec">Мощность — 150–165 л.с.</p>
        ...
        <section class="product-description">
            <div class="product-description__inner">
                ...
                <p class="product-description__text">Двигатель G4KD — бензиновый агрегат объёмом 2.0 л семейства Theta, который устанавливается на ряд моделей Hyundai и Kia и часто выбирается как готовое решение для замены без затяжного ремонта. Перед подбором мы сверяем совместимость по VIN и уточняем комплектацию, чтобы двигатель подошёл по креплениям, навесному оборудованию и датчикам — это помогает избежать лишних расходов и ускоряет установку. Если вам нужен g4kd двигатель без пробега, имеет смысл заранее проверить маркировку, комплектность и наличие документов: так проще подтвердить соответствие и спокойно вводить мотор в эксплуатацию.<br>Мы подскажем, что лучше согласовать до отправки: фото/видео подтверждение, упаковку, условия гарантии и нюансы доставки. Многие клиенты приходят с запросом купить g4kd, когда хотят получить узел в сборе и быстро вернуть автомобиль в работу. Если вы пишете “куплю двигатель g4kd”, мы уточним требования и предложим подходящий вариант под конкретный автомобиль. Также можно подобрать g4kd мотор с документами и гарантией, а стоимость и условия доставки согласуем при оформлении заказа.</p>
                ...
                <table class="spec-table" style="margin-bottom:8px;">
                    <tbody>
                        <tr><td>Киа G4KD / G4KD Kia</td><td>G4KD</td></tr>
                        <tr><td>Хендай G4KD / G4KD Hyundai</td><td>G4KD</td></tr>
                        <tr><td>АйИкс35 G4KD / G4KD ix35</td><td>G4KD</td></tr>
                        <tr><td>Оптима G4KD / G4KD Optima</td><td>G4KD</td></tr>
                        <tr><td>Соната G4KD / G4KD Sonata</td><td>G4KD</td></tr>
                    </tbody>
                </table>
                ...
                <table class="spec-table">
                    <tbody>
                        ...
                        <tr><td>Точный объём</td><td>1 998 см³</td></tr>
                        <tr><td>Диаметр цилиндра</td><td>86 мм</td></tr>
                        <tr><td>Ход поршня</td><td>86 мм</td></tr>
                        <tr><td>Система питания</td><td>инжектор</td></tr>
                        <tr><td>Мощность</td><td>150–165 л.с.</td></tr>
                        <tr><td>Крутящий момент</td><td>192–210 Нм</td></tr>
        ...
        <section class="faq">
            <div class="faq__inner">
				...
				<div class="faq__list">
					<!-- вопросы из документа -->
					<div class="faq__item reveal reveal--left">
						<button class="faq__question" aria-expanded="false">
							<span>На какие автомобили подходит двигатель G4KD?</span>
							<svg class="faq__icon" viewBox="0 0 24 24"><path d="M19 9l-7 7-7-7"/></svg>
						</button>
						<div class="faq__answer">
							<div class="faq__answer-inner">Двигатель G4KD устанавливается на ряд моделей Hyundai и Kia (включая ix35/Optima/Sonata на отдельных комплектациях). Для точного подбора пришлите VIN — проверим совместимость и нужную комплектацию.</div>
						</div>
					</div>
					<div class="faq__item reveal reveal--left">
						<button class="faq__question" aria-expanded="false">
							<span>Какие документы идут вместе с двигателем G4KD?</span>
							<svg class="faq__icon" viewBox="0 0 24 24"><path d="M19 9l-7 7-7-7"/></svg>
						</button>
						<div class="faq__answer">
							<div class="faq__answer-inner">Двигатель поставляется с комплектом документов. Перед отправкой подтвердим маркировку и при необходимости сделаем фото/видео.</div>
						</div>
					</div>
					<div class="faq__item reveal reveal--left">
						<button class="faq__question" aria-expanded="false">
							<span>Какая гарантия на новый двигатель G4KD и как проходит доставка?</span>
							<svg class="faq__icon" viewBox="0 0 24 24"><path d="M19 9l-7 7-7-7"/></svg>
						</button>
						<div class="faq__answer">
							<div class="faq__answer-inner">Гарантия на двигатель — 180 дней. Доставляем по России, условия и стоимость доставки уточняются при оформлении заказа.</div>
						</div>
					</div>
					<!-- типовые вопросы -->
					<div class="faq__item reveal reveal--left">
